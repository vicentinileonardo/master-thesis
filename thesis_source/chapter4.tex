...
One of the most convenient approaches is packaging them as \textbf{OCI (Open Container Initiative) images} and this is the approach adopted in the system described in this thesis.
...
As a matter of fact, policies are maintained in a \textbf{version-controlled repository} (i.e., on GitHub), where updates trigger an automated pipeline (e.g., using GitHub Actions) responsible for building, packaging into a OCI image, and publishing the policy bundle to a container registry (e.g., Docker Hub).
