...
Listing \ref{lst:values.schema.json} shows the corresponding JSON schema for the values.yaml file.
...
In our case, we defined a helper function called \textit{findBestVmSize} that takes as input the CPU and RAM requirements of the VM and returns the best provider-specific VM size available.
