...
In order to define a generic VM resource, we leverage Krateo Core Provider by creating a VmTemplate CompositionDefinition

Effectively 


Listing \ref{lst:values.yaml} shows an example of 
