...
As a matter of fact, the custom Kubernetes operator was originally designed to handle only virtual machines (VMs).
...
In the context of this work, the ``Scheduling outcome policy'' is a policy that determines the scheduling decision for a given workload based on the output of the GreenOps Scheduler. 


It is therefore a mutation policy that has the duty to create 
