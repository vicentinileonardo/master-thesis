...
\begin{lstlisting}[caption={values.schema.json}, label={lst:values.schema.json}]
{
  "type": "object",
...
Helm templating engine is also leveraged to handle the \textbf{scheduling time waiting logic}.
