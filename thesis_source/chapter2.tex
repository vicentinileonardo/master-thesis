...
\section{Multi-cloud resource management - takeaways}
...
We can list some of the major recurrent elements that are generally needed in order to build a system for multi-cloud resource management:
\begin{enumerate}
