...
In the system proposed by this thesis, the elements listed above are represented by \textbf{cloud-native components} in the Kubernetes ecosystem as described in the following chapters and as shown in Table \ref{tab:components_mapping}.


From a general standpoint, the system proposed in this thesis is different from the state of the ar
[real production system, not simulation]
[variety of resources managed thanks to how the system is designed]
