...
% https://www.statista.com/statistics/1491357/microsoft-azure-availability-zones-global-by-region/
...
To give an idea of the geo-distribution of cloud regions, Figure \ref{fig:azure_data_centers} shows the location of \textbf{Azure cloud data centers} around the world and the country Grid Carbon Intensity as reported by Electricity Maps (year 2024) \cite{electricity_maps}.
